...
<div class="row">
 ...
 $time  = $hasil['tanggal'];   
  ?>		  
							...
							<td>
                                  <div class="btn-group">
                                      <a class="btn btn-primary" href="index_admin.php?page=input_berita&id=<?php echo $id;?>"><i class="icon_plus_alt2"></i></a>
                                      <a class="btn btn-success" href="index_admin.php?page=edit_berita&id=<?php echo $id;?>"><i class="icon_check_alt2"></i></a>
                                      <a class="btn btn-danger" href="index_admin.php?page=delete_berita&id=<?php echo $id;?>"><i class="icon_close_alt2"></i></a>
                                  </div>
                                  </td>
                              </tr>
	        <?php } ?>
