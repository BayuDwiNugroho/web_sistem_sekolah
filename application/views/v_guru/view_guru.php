          ...
          <section class="wrapper"> 
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
                        <li><i class="fa fa-laptop"></i>Data Guru</li>                          
                    </ol>
                </div>
            </div>              
            <div class="row">
                <div class="col-md-12">
                    ...
                    <a class='btn btn-info' href="<?php echo base_url('show_nilai/tambah1'); ?>">Tambah Data</a>
                   <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                    ...
                    <?php foreach ($query->result() as $data){
                                        ...
                                        echo "<td>".$data->nilai_tgs."</td>";
                                        echo "<td>".$data->nilai_uts."</td>";
                                        echo "<td>".$data->nilai_uas."</td>";
                                        echo "<td>
                                             <div class='btn-group'><a class='btn btn-warning' href=".base_url('show_nilai/edit_nilai/').$data->id_lap.">Edit</a></div>";
                                        echo "<div class='btn-group'><a class='btn btn-danger' href=".base_url('show_nilai/hapus_nilai/').$data->id_lap.">Hapus</a>";
                                        echo"</td>";
                                        echo"</tr>";
