      ...
      <!--main content start-->
       <section id="main-content">
          <section class="wrapper"> 
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><i class="fa fa-laptop"></i>Edit Guru</h3>
                    <ol class="breadcrumb">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form action="<?php echo base_url('show_guru/update_guru'); ?>" method="POST">

                    <?php foreach ($guru->result() as $baris) { ?>

                        <tr>
                            <td>ID</td>
                            <td><input type="text" class="form-control" name="id_guru" readonly value="<?php echo $baris->id_guru; ?>"></td>
                        </tr>
                        <tr>
                            <td>Nama Guru</td>
                            <td><input type="text" class="form-control" name="nama_guru" value="<?php echo $baris->nama_guru; ?>"></td>
                        </tr>
                            <td>MAPEL</td>
                            <td><input type="text" class="form-control" name="mapel" value="<?php echo $baris->mapel; ?>"></td>
                        <tr>
