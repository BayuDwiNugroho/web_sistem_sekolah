      ...
      <!--main content start-->
       <section id="main-content">
          <section class="wrapper"> 
            ...
            <form method="POST" action="<?php echo base_url()."show_guru/insert_guru";?>">
                    <table cellpadding="8">
                        <tr>
                            <td>ID</td>
                            <td><input type="text" class="form-control" name="id_guru" ></td>
                        </tr>
                        <tr>
                            <td>Nama Guru</td>
                    ...
                    <a  class="btn btn-danger" href="<?php echo base_url('show_guru/tampil_admin_guru'); ?>" type="reset" value="Batal">Batal</a>
        <?php //echo form_close(); ?>
