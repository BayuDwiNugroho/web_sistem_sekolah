...
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <header class="header dark-bg">
            ...
            <!--logo start-->
            <a href="index.html" class="logo">Guru  || <span class="lite">KU</span></a>
            <!--logo end-->
      ...
      <!--main content start-->
       <section id="main-content">
          <section class="wrapper"> 
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><i class="fa fa-laptop"></i>GURU</h3>
                    <ol class="breadcrumb">
                        <li><i class="fa fa-laptop"></i>File GURU</li>                          
                    </ol>
                </div>
            </div>              
            <div class="row">
                <div class="col-md-12">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                      <thead>
                              <tr>
                                 <p style="text-align:center" border="black"><h1><center><b> Selamat Datang di SD BDN </b></center></h1></p>
                                 <p style="text-align:center" border="black"><h3><center>  </center></h3></p>
                              </tr> 
                             
                              </thead>
                              <tbody>
                              <br><br><br><br> <center>                           
                              <a class="btn btn-success" href="<?php echo base_url()."show_nilai/tampil_nilai";?>">Laporan Nilai   </a> || 
                              <a class="btn btn-info" href="<?php echo base_url()."show_nilai/tampil_siswa";?>">Data Siswa</a>
                                </center>
                            </tbody>
                        </table>
                  </div>
