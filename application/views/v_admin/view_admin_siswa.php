          ...
          <section class="wrapper"> 
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <a class='btn btn-info' href="<?php echo base_url('show_siswa/tambah_siswa'); ?>">Tambah Data</a>
                   <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                      ...
                      ?>
                              <tr><th><i class="icon_profile"></i>No</th> 
                                 ...
                                 <th><i class="icon_calendar"></i> Agama</th>
                    ...
                    <?php foreach ($siswa->result() as $data){
                                        ...
                                        echo "<td>
                                             <div class='btn-group'><a class='btn btn-warning' href=".base_url('show_siswa/edit_siswa/').$data->id_siswa.">Edit </a></div> || ";
                                        echo "<div class='btn-group'><a class='btn btn-danger' href=".base_url('show_siswa/hapus_siswa/').$data->id_siswa.">Hapus</a>";
                                        echo"</td>";
                                        echo"</tr>";
