...
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <header class="header dark-bg">
            ...
            <!--logo start-->
            <a href="index.html" class="logo">Admin || <span class="lite">KU</span></a>
            <!--logo end-->
          ...
          <section class="wrapper"> 
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
                        <li><i class="fa fa-laptop"></i>File Admin</li>                          
                    </ol>
                </div>
            </div>              
            <div class="row">
                <div class="col-md-12">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                      <thead>
                              <tr>
                                 <p style="text-align:center" border="black"><h1><center><b> Selamat Datang Admin  di SD BDN </b></center></h1></p>
                              ...
                              <tbody>
                              <br><br><br><br> <center>                           
                              <a class="btn btn-success" href="<?php echo base_url()."show_guru/tampil_admin_guru";?>">Data Guru   </a> || 
                              <a class="btn btn-info" href="<?php echo base_url()."show_siswa/tampil_admin_siswa";?>">Data Siswa</a>
                                </center>
                            </tbody>
                        </table>
                  </div>
