          ...
          <section class="wrapper"> 
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <a class='btn btn-info' href="<?php echo base_url('show_guru/tambah_guru'); ?>">Tambah Data</a>
                   <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                    ...
                    <?php foreach ($guru->result() as $data){
                                       ...
                                       $no_urut++;
                                        ...
                                        echo "<td>
                                             <div class='btn-group'><a class='btn btn-warning' href=".base_url('show_guru/edit_guru/').$data->id_guru.">Edit </a></div> || ";
                                        echo "<div class='btn-group'><a class='btn btn-danger' href=".base_url('show_guru/hapus_guru/').$data->id_guru.">Hapus</a>";
                                        echo"</td>";
                                        echo"</tr>";
