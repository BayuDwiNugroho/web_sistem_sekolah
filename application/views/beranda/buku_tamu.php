				...
				<div class="col-lg-9">
					<div class="main_content">
						...
						<div class="blog_section">
							<p style="color: black;"><h2>Buku Tamu</h2></p><hr>
							<p style="color: black;">Silahkan mengisi buku tamu pada form dibawah ini untuk memberikan kritik maupun saran kepada kami. Setiap buku tamu yang masuk, kami akan sangat menghargainya.</p>
 							<form id="formKomentar" action="<?php echo base_url()."show_siswa/insert_buku";?>" method="POST">
                                <div>
