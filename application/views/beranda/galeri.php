			...
			<div class="row row-lg-eq-height">
				...
				<div class="col-lg-9">
					<div class="main_content">
						...
						<img src="<?php echo base_url()."assets/img/or.jpg";?>" alt="New York" width="1200" height="700"><p>
						<p style="color: black;">
							Kegiatan Olah Raga di SD BDN </p><br><hr>
							<img src="<?php echo base_url()."assets/img/pramuka.jpg";?>" alt="New York" width="1200" height="700"><p>
						<p style="color: black;">
							Kegiatan Pramuka di SD BDN </p><br><hr>
							<img src="<?php echo base_url()."assets/img/gerak.jpg";?>" alt="New York" width="1200" height="700"><p>
						<p style="color: black;">
							Kegiatan Gerak Jalan di SD BDN </p>
