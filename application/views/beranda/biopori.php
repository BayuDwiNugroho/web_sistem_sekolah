			...
			<div class="row row-lg-eq-height">
				...
				<div class="col-lg-9">
					<div class="main_content">
						...
						<img src="<?php echo base_url()."assets/img/biopori.jpg";?>" alt="New York" width="1200" height="700"><p>
						<p style="color: black;">
							SD BDN adalah sekolah adiwiyata dan tahun 2017 ini SD BDN  ingin meraih adiwiyata tingkat nasional. </p>
						<p  style="color: black;">

							Untuk itu sekolah banyak melakukan perbaikan dalam hal lingkungan. salah satunya adalah dengan menanam 215 lubang biopori yang bertujuan untuk menambah resapan air hujan dan membuat kompos secara alami .

							Pembuatan biopori ini melibatkan murid - murid SD BDN agar mereka mengerti bagaimana cara membuat dan apa manfaat dari biopori tersebut
