			...
			<div class="row row-lg-eq-height">
				...
				<div class="col-lg-9">
					<div class="main_content">
						...
						<img src="<?php echo base_url()."assets/img/kebun.jpg";?>" alt="New York" width="1200" height="700"><p>
						<p style="color: black;">
							Setiap bulan SD Patra Dharma 1 Balikpapan selalu memanen tanaman yang di tanam di kebun sekolah. </p>
						<p  style="color: black;">
						Lalu selesai memanen para murit dan guru membuka lapak penjualan hasil panen kepada orang tua murit dan warga sekitar. Keuntungan dari penjualan hasil panen tersebut akan di gunakan untuk membeli bibit tanaman dan akan di tanam lagi di kebunsekolah.</p>
						</div>
