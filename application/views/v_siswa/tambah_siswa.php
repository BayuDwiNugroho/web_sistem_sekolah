      ...
      <!--main content start-->
       <section id="main-content">
          <section class="wrapper"> 
            ...
            <form method="POST" action="<?php echo base_url()."show_siswa/insert_siswa";?>">
                    <table cellpadding="8">
                        <tr>
                            <td>ID Siswa</td>
                            <td><input type="text" class="form-control" name="id_siswa" placeholder="Id Siswa"></td>
                        </tr>
                        <tr>
                            <td>Nama Siswa</td>
                    ...
                    <a  class="btn btn-danger" href="<?php echo base_url('show_siswa/tampil_admin_siswa'); ?>" type="reset" value="Batal">Batal</a>
        <?php //echo form_close(); ?>
