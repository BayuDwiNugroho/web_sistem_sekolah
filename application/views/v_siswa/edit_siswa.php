      ...
      <!--main content start-->
       <section id="main-content">
          <section class="wrapper"> 
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><i class="fa fa-laptop"></i> Data Siswa</h3>
                    <ol class="breadcrumb">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form action="<?php echo base_url('show_siswa/update_siswa'); ?>" method="POST">

                    <?php foreach ($siswa->result() as $baris) { ?>

                        <tr>
                            <td>ID</td>
                            <td><input type="text" class="form-control" name="id_siswa" readonly value="<?php echo $baris->id_siswa; ?>"></td>
                        </tr>
                        <tr>
                            <td>Nama Siswa</td>
                        ...
                        <tr>
                            <td>Agama</td>
                            <td><input type="text" class="form-control" name="agama" value="<?php echo $baris->agama; ?>" ></td>
                        </tr>
                        <tr>
                            <td>Alamat</td>
                            <td><input type="text" class="form-control" name="alamat" value="<?php echo $baris->alamat; ?>"></td>
                        </tr>
