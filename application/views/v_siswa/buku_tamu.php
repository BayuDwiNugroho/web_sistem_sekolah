						...
						<div class="logo"><a href="<?php echo base_url('dashboard')?>"><h3>"SD BDN"</h3></a></div>
							<nav class="main_nav">
								<ul>
									...
									<li><a href="<?php echo base_url('dashboard/siswa')?>"><h4>Data Siswa</h4></a></li>
									<li><a href="<?php echo base_url('dashboard/guru')?>"><h4>Data Guru</h4></a></li>
									<li></li>
								</ul>
							</nav>
							<div class="search_container ml-auto">
	  ...
	  <div id="myCarousel" class="carousel slide" data-ride="carousel">
                                      ...
                                      <!-- Wrapper for slides -->
                                        ...
                                        <div class="item active">
                                           <a href="<?php echo base_url()."dashboard/biopori";?>"><img src="<?php echo base_url()."assets/img/biopori.jpg";?>" alt="New York" width="1200" height="700"></a>
                                        ...
                                        <div class="item">
                                          <a href="<?php echo base_url()."dashboard/kebun";?>"><img src="<?php echo base_url()."assets/img/kebun.jpg";?>" alt="Chicago" width="1200" height="700"></a>
                                          <div class="carousel-caption">
                                        ...
                                        <div class="item">
                                          <a href="<?php echo base_url()."dashboard/juara";?>"><img src="<?php echo base_url()."assets/img/juara.jpg";?>" alt="Los Angeles" width="1200" height="700"></a>
                                          <div class="carousel-caption">
			...
			<div class="row row-lg-eq-height">
				...
				<div class="col-lg-9">
					<div class="main_content">
						...
						<p style="color: black;"><h2>Buku Tamu</h2></p>
						<p style="color: black;">Silahkan mengisi buku tamu pada form dibawah ini untuk memberikan kritik maupun saran kepada kamu. Setiap buku tamu yang masuk, kami akan sangat menghargainya.</p>
									...
									<div class="owl-carousel owl-theme sidebar_slider_top">
										...
										<div class="owl-item">
											...
											<div class="side_post">
												<a href="post.html">
													<div class="d-flex flex-row align-items-xl-center align-items-start justify-content-start">
														<div class="side_post_image"><div><img src="<?php echo base_url()."assets/images/top_1.jpg";?>" alt=""></div></div>
											...
											<div class="side_post">
												<a href="post.html">
													<div class="d-flex flex-row align-items-xl-center align-items-start justify-content-start">
														<div class="side_post_image"><div><img src="<?php echo base_url()."assets/images/top_3.jpg";?>" alt=""></div></div>
														<div class="side_post_content">
															<div class="side_post_title">How Did van Gogh’s Turbulent Mind</div>
															<small class="post_meta">Katy Liu<span>Sep 29</span></small>
														</div>
