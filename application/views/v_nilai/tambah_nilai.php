...
<html lang="en">
  ...
  <body>
    <!-- container section start --><section id="container" class="">
          ...
          <section class="wrapper"> 
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
                        <li><i class="fa fa-laptop"></i> Tambah Nilai</li>                          
                    </ol>
                </div>
            </div>              
            <div class="row">
            ...
            <?php //echo form_open("show_nilai/tambah"); ?>
            <form method="POST" action="<?php echo base_url()."show_nilai/insert1";?>">
                    <table cellpadding="8">
                        <tr>
                            <td>ID</td>
                            <td><input type="text" class="form-control" name="id_lap" placeholder="Id Siswa"></td>
                        </tr>
                        <tr>
                            <td>Nama Siswa</td>
                        ...
                        <tr>
                            <td>Kelas</td>
                            <td><input type="text" class="form-control" name="kelas" placeholder="Kelas" ></td>
                        </tr>
                         <tr>
                            <td>Nilai IPA </td>
                            <td><input type="text" class="form-control" name="nilai_ipa"  placeholder="Nilai IPA"></td>
                        </tr>

                        <tr>
                            <td>Nilai IPS </td>
                            <td><input type="text" class="form-control" name="nilai_ips" placeholder="Nilai IPS"></td>
                        </tr>
                        <tr>
                            <td>Nilai Matematika </td>
                            <td><input type="text" class="form-control" name="nilai_mtk"  placeholder="Nilai Matematika"></td>
                        </tr>
                        <tr>
                            <td>Nilai B.Indonesia </td>
                            <td><input type="text" class="form-control" name="nilai_bind" placeholder="Nilai IPA"></td>
                        </tr>
                        <tr>
                            <td>Nilai B.Inggris </td>
                            <td><input type="text" class="form-control" name="nilai_bing"placeholder="Nilai B.Inggris"></td>
                        </tr>
                    ...
                    <a  class="btn btn-danger" href="<?php echo base_url('show_nilai/tampil_nilai'); ?>" type="reset" value="Batal">Batal</a>
        <?php //echo form_close(); ?>
