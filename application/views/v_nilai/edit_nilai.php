...
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <header class="header dark-bg">
            ...
            <!--logo start-->
            <a href="" class="logo">Guru  || <span class="lite">KU</span></a>
            <!--logo end-->
          ...
          <section class="wrapper"> 
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form action="<?php echo base_url('show_nilai/update_nilai'); ?>" method="POST">

                    <?php foreach ($query->result() as $baris) { ?>

                        <tr>
                            <td>ID</td>
                            <td><input type="text" class="form-control" name="id_lap" readonly value="<?php echo $baris->id_lap; ?>"></td>
                        </tr>
                        <tr>
                            <td>Nama Siswa</td>
                            <td><input type="text" class="form-control" name="nama_siswa" value="<?php echo $baris->nama_siswa; ?>"></td>
                        </tr>
                                                
                        </tr>
                        <tr>
                            <td>Kelas</td>
                            <td><input type="text" class="form-control" name="kelas" value="<?php echo $baris->kelas; ?>" ></td>
                        </tr>
                        <tr>
                            <td>Nilai IPA </td>
                            <td><input type="text" class="form-control" name="nilai_ipa" value="<?php echo $baris->nilai_ipa; ?>" placeholder="Nilai IPA"></td>
                        </tr>

                        <tr>
                            <td>Nilai IPS </td>
                            <td><input type="text" class="form-control" name="nilai_ips" value="<?php echo $baris->nilai_ips; ?>" placeholder="Nilai IPS"></td>
                        </tr>
                        <tr>
                            <td>Nilai Matematika </td>
                            <td><input type="text" class="form-control" name="nilai_mtk" value="<?php echo $baris->nilai_mtk; ?>" placeholder="Nilai Matematika"></td>
                        </tr>
                        <tr>
                            <td>Nilai B.Indonesia </td>
                            <td><input type="text" class="form-control" name="nilai_bind" value="<?php echo $baris->nilai_bind; ?>" placeholder="Nilai IPA"></td>
                        </tr>
                        <tr>
                            <td>Nilai B.Inggris </td>
                            <td><input type="text" class="form-control" name="nilai_bing" value="<?php echo $baris->nilai_bing; ?>" placeholder="Nilai B.Inggris"></td>
                        </tr>
